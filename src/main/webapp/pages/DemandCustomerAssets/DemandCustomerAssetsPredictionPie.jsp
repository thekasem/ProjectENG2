...
<html>
<head>
<title>prediction total purchase value</title>
<meta charset="utf-8">
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background: #2C3B41;">
			...
			<h1>
				All prediction total purchase values <small>Computer
					Engineering</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="#" style="color: white"><i class="fa fa-home"></i>
						All prediction total purchase </a></li>
			...
			<div class="row">
				...
				<div class="box box-warning">
					<div class="box-header with-border">
						<Strong>All prediction total purchase values</Strong>
					</div>
