...
<html>
<head>
<title>Demand Customer Assets Each Analysis Scatter</title>
<meta charset="utf-8">
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background: #2C3B41;">
			...
			<h1>
				Demand Customer Assets Each Analysis Scatter <small>Computer
					Engineering</small>
			</h1>
			<ol class="breadcrumb">
							...
							<div class="row well">
								...
								<div class="col-md-1">
									<s:a type="button" class="btn btn-primary"
										href="eachanalysis_analysisscatter">
	...
	<script src="GraphAnalysis/scatterEachAnalysis.js"></script>
