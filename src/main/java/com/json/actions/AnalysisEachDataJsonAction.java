...
public class AnalysisEachDataJsonAction extends ActionSupport {
	...
	public String getDataEachCustomer() {
		...
		dateList = analysisBuyAsset.getDateList(selectTime, fromYear, toYear,
				fromMonth, toMonth, toYearII);
		List<Object[]> listCustomer = analysisBuyAsset.getValueEachCustomer(
				dateList, selectTime, assetId);
	...
	public String getDataEachAsset() {
		...
		dateList = analysisBuyAsset.getDateList(selectTime, fromYear, toYear,
				fromMonth, toMonth, toYearII);
		List<Object[]> listAsset = analysisBuyAsset.getValueEachAsset(dateList,
				selectTime, customerId);
		getAsset(listAsset);
